  ...
  if (loading && !stats)
    return (
      <div className="min-h-screen bg-[#0C0A09] flex flex-col items-center justify-center font-sans px-5">
        ...
        <p className="text-stone-600 text-xs font-bold tracking-tight animate-pulse">
          {" "}
      ...
      <div className="max-w-6xl mx-auto px-6 pt-10">
        ...
        <header className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 gap-6">
          ...
          <div className="animate-in slide-in-from-left duration-700">
            {" "}
            <div className="flex items-center gap-3 text-orange-600 text-xs font-bold tracking-tight mb-4 bg-orange-600/5 w-fit px-5 py-2 rounded-full border border-orange-600/10">
              {" "}
              <ShieldCheck
                size={14}
            ...
            <h1 className="text-4xl font-bold tracking-tight leading-none text-white drop-shadow-2xl">
              {" "}
              Overview{" "}
            </h1>{" "}
            <p className="text-stone-500 text-xs font-bold tracking-tight mt-4 ml-1 opacity-80 italic">
              {" "}
              Real-time system metrics and professional resource management{" "}
            </p>{" "}
          </div>{" "}
          <div className="flex items-center gap-4 animate-in slide-in-from-right duration-700">
            ...
            <div className="bg-[#171412] px-5 py-3 rounded-xl border border-stone-800/80 flex items-center gap-4 shadow-2xl relative overflow-hidden group">
              ...
              <div>
                {" "}
                <p className="text-xs font-bold tracking-tight text-stone-600 mb-0.5">
                  {" "}
                  System Status{" "}
                </p>{" "}
                <p className="text-xs font-bold tracking-tight text-white flex items-center gap-2">
                  {" "}
                  Optimal{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12 animate-in fade-in duration-1000 delay-300">
          ...
          {[
            ...
            {
              label: "Pending Queue",
              val: stats?.pendingToday || 0,
              icon: <Activity size={20} />,
              sub: "Waiting Students",
              color: "blue",
            },
            {
              label: "Avg Wait Time",
              val: `${stats?.avgWaitTime || 0}m`,
              icon: <Clock size={20} />,
              sub: "Estimated Delay",
              color: "stone",
            },
            ...
            <div
              key={i}
              className="bg-[#171412] p-6 rounded-2xl border border-stone-800/60 relative overflow-hidden group hover:border-orange-600/40 transition-all duration-700 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] cursor-default"
            >
              {" "}
              <div
                className={`absolute top-0 right-0 w-32 h-32 bg-orange-600 opacity-0 group-hover:opacity-[0.03] transition-opacity blur-[40px] pointer-events-none`}
              />{" "}
              <div className="flex items-center justify-between mb-8">
                {" "}
                <p className="text-stone-600 text-xs font-bold tracking-tight">
                  {" "}
                  {stat.label}{" "}
                </p>{" "}
              ...
              <h3 className="text-3xl font-bold tracking-tight mb-2 text-white drop-shadow-lg">
                {" "}
                {stat.val}{" "}
              </h3>{" "}
              <p className="text-stone-700 text-xs font-bold tracking-tight">
                {" "}
                {stat.sub}{" "}
              </p>{" "}
            </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-20 animate-in slide-in-from-bottom-10 duration-1000 delay-500">
          ...
          <div className="bg-[#171412] p-6 rounded-[2.5rem] border border-stone-800/60 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden relative group">
            ...
            <div className="flex items-center justify-between mb-10 relative z-10">
              ...
              <div>
                {" "}
                <h3 className="text-lg font-bold tracking-tight text-white flex items-center gap-5">
                  {" "}
                ...
                <p className="text-stone-600 text-xs font-bold tracking-tight mt-3 ml-16">
                  {" "}
                  Transaction density per service unit{" "}
                </p>{" "}
              </div>{" "}
              <ArrowUpRight
                className="text-stone-800 group-hover:text-orange-600 transition-colors"
                size={24}
                strokeWidth={3}
              />{" "}
            </div>{" "}
                ...
                <div key={i} className="group/item">
                  ...
                  <div className="flex justify-between mb-5 items-end">
                    ...
                    <div className="flex items-center gap-6">
                      {" "}
                      <div className="w-14 h-14 rounded-[1.5rem] bg-stone-950 border border-stone-800 flex items-center justify-center font-bold tracking-tight text-xs text-stone-600 group-hover/item:text-orange-600 group-hover/item:border-orange-600/40 transition-all shadow-inner">
                        {" "}
                        {s.prefix || s.name.charAt(0)}{" "}
                      </div>{" "}
                      <div>
                        {" "}
                        <span className="text-xl font-bold tracking-tight text-stone-400 group-hover/item:text-white transition-colors duration-500">
                          {" "}
                          {s.name}{" "}
                        </span>{" "}
                        <p className="text-xs font-bold tracking-tight text-stone-700 mt-1.5 opacity-60">
                          {" "}
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-stone-700 font-bold tracking-tight mt-1">
                        {" "}
                        Pending Tokens{" "}
                      </p>{" "}
                    </div>{" "}
                  ...
                  <div className="w-full bg-stone-950 h-5 rounded-full overflow-hidden border-2 border-stone-900 shadow-inner p-1 group/bar">
                    ...
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, (s.count / (stats.totalTokensToday || 1)) * 100)}%`,
                      }}
                    />{" "}
                  </div>{" "}
                </div>
              ...
              {(!stats?.serviceStats || stats.serviceStats.length === 0) && (
                <div className="py-24 text-center opacity-10 flex flex-col items-center gap-6">
                  ...
                  <p className="text-sm font-bold tracking-tight italic">
                    {" "}
                    Waiting for active service data...{" "}
                  </p>{" "}
                </div>
              )}{" "}
            </div>{" "}
          ...
          <div className="bg-[#171412] p-6 rounded-[2.5rem] border border-stone-800/60 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col group">
            ...
            <div className="flex items-center justify-between mb-16 relative z-10">
              ...
              <div>
                ...
                <p className="text-stone-600 text-xs font-bold tracking-tight mt-3 ml-16">
                  {" "}
                  24-hour volume monitoring and peak analysis{" "}
                </p>{" "}
              </div>{" "}
              <div className="bg-stone-950/80 px-5 py-2.5 rounded-2xl border border-stone-800 shadow-inner flex items-center gap-4">
                ...
                <span className="text-xs font-bold tracking-tight text-stone-500">
                  {" "}
                  Live Sweep{" "}
                </span>{" "}
              </div>{" "}
            ...
            <div className="flex-1 flex items-end justify-between gap-3 px-6 h-64 relative pt-16 z-10">
              ...
              {peakHours.map((h, i) => (
                <div
                  key={i}
                  className="relative group/bar flex-1 h-full flex flex-col justify-end gap-5"
                >
                  {" "}
                  <div
                    ...
                    style={{
                      height: `${Math.max(8, Math.min(100, (h / Math.max(...peakHours, 1)) * 100))}%`,
                    }}
                  >
                    {" "}
                    {h > 0 && (
                      <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-[#171412] border border-stone-700 px-5 py-3 rounded-2xl opacity-0 group-hover/bar:opacity-100 transition-all duration-300 z-50 shadow-[0_30px_60px_rgba(0,0,0,0.8)] pointer-events-none scale-90 group-hover/bar:scale-100 backdrop-blur-md">
                        {" "}
                        <p className="text-xs font-bold tracking-tight text-white whitespace-nowrap">
                          {" "}
                          {h} TOKENS{" "}
                        </p>{" "}
                      </div>
                  ...
                  <div
                    className={`w-full h-1.5 rounded-full transition-colors ${i % 4 === 0 ? "bg-stone-800" : "bg-transparent"}`}
                  />{" "}
                </div>
              ))}{" "}
            </div>{" "}
            <div className="mt-8 flex justify-between px-6 relative z-10">
              ...
              {[
                ...
                <span
                  key={i}
                  className="text-xs font-bold tracking-tight text-stone-800"
                >
                  {" "}
                  {t}{" "}
                </span>
        ...
        <div className="bg-[#171412] rounded-[2.5rem] border border-stone-800/60 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden mb-20 animate-in slide-in-from-bottom-20 duration-1000 delay-700">
          ...
          <header className="p-6 border-b border-stone-800/30 flex justify-between items-center bg-stone-900/20">
            ...
            <div>
              {" "}
              <h3 className="text-xl font-bold tracking-tight text-white flex items-center gap-5">
                {" "}
              ...
              <p className="text-stone-600 text-xs font-bold tracking-tight mt-3 ml-16 opacity-80">
                {" "}
                Chronological list of recent system interactions{" "}
              </p>{" "}
            </div>{" "}
            <Link
              to="/admin/analytics"
              className="bg-stone-900/50 border border-stone-800 px-6 py-4 rounded-xl text-xs font-bold tracking-tight text-stone-500 hover:text-white hover:border-orange-600/40 transition-all flex items-center gap-4 group shadow-xl backdrop-blur-md"
            >
              {" "}
              Full Analytics{" "}
              <ChevronRight
          ...
          <div className="overflow-x-auto">
            ...
            <table className="w-full text-left">
              ...
              <thead>
                {" "}
                <tr className="text-stone-700 text-xs font-bold tracking-tight border-b border-stone-800/20 bg-stone-950/30">
                  {" "}
              ...
              <tbody className="divide-y divide-stone-800/10">
                ...
                {recentActivity.map((log, i) => (
                  <tr
                    key={i}
                    className="group hover:bg-stone-900/40 transition-all duration-500"
                  >
                    {" "}
                    <td className="px-8 py-6 font-mono text-xs text-stone-700 group-hover:text-orange-600 transition-colors">
                      {" "}
                      #{log.id?.slice(-8) || `ACT-${2000 + i}`}{" "}
                    </td>{" "}
                    <td className="px-8 py-6">
                      ...
                      <div className="inline-flex items-center gap-5 px-6 py-2.5 bg-stone-950/50 border border-stone-800/60 rounded-2xl group-hover:border-stone-700 transition-all shadow-inner">
                        ...
                        <span className="text-xs font-bold tracking-tight text-stone-600 group-hover:text-stone-400 transition-colors">
                          {" "}
                          {log.module || "SYSTEM"}{" "}
                        </span>{" "}
                      </div>{" "}
                    </td>{" "}
                    <td className="px-8 py-6 text-sm font-bold tracking-tight text-stone-400 leading-relaxed italic group-hover:text-white transition-colors duration-500">
                      {" "}
                      {log.desc}{" "}
                    </td>{" "}
                    <td className="px-8 py-6">
                      {" "}
                      <p className="text-xs font-bold tracking-tight text-stone-800 group-hover:text-stone-600 transition-colors">
                        {" "}
                        {log.sub || "GENERAL"}{" "}
                      </p>{" "}
                    </td>{" "}
                    <td className="px-8 py-6 text-right">
                      {" "}
                      <div
                        className={`inline-flex items-center gap-4 px-6 py-3 rounded-full border-2 ${log.status === "Completed" ? "border-emerald-900/20 bg-emerald-900/5 shadow-[0_0_20px_rgba(16,185,129,0.05)]" : "border-orange-900/20 bg-orange-900/5 shadow-[0_0_20px_rgba(234,88,12,0.05)]"}`}
                      >
                        {" "}
                        <div
                          className={`w-2.5 h-2.5 rounded-full ${log.status === "Completed" ? "bg-emerald-500 animate-pulse" : "bg-orange-600"}`}
                        />{" "}
                        <span
                          className={`text-xs font-bold tracking-tight ${log.status === "Completed" ? "text-emerald-500" : "text-orange-500"}`}
                        >
                          {" "}
                ...
                {(!recentActivity || recentActivity.length === 0) && (
                  <tr>
                    ...
                    <td
                      colSpan={5}
                      className="px-8 py-48 text-center opacity-10 italic"
                    >
                      {" "}
                      <div className="flex flex-col items-center gap-8">
                        {" "}
                        <ClipboardList size={110} strokeWidth={1} />{" "}
                        <p className="text-2xl font-bold tracking-tight ml-12">
                          {" "}
                          No Log Signatures{" "}
                        </p>{" "}
                      </div>{" "}
