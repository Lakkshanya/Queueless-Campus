    ...
    <div className="min-h-screen bg-[#1C1917] flex flex-col items-center justify-center relative overflow-hidden font-sans">
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: ` @keyframes shimmer { 0% { transform: translateX(-150%); width: 20%;} 50% { transform: translateX(150%); width: 50%;} 100% { transform: translateX(450%); width: 20%;}} .perspective-1000 { perspective: 1000px;}`,
        }}
      />{" "}
    </div>
  );
