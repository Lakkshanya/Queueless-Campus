    ...
    <div className="min-h-screen bg-[#1C1917] flex flex-col items-center justify-between py-16 px-6 font-sans relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-2xl text-center relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4 w-full mb-12 animate-in fade-in duration-1000 delay-500">
          ...
          <div className="bg-[#292524]/50 border border-stone-800 p-4 rounded-2xl flex flex-col items-center gap-2">
            ...
            <span className="text-[#FAFAF9] text-[10px] font-black uppercase tracking-widest">Live Analytics</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-in slide-in-from-bottom-8 duration-700 delay-700">
        <button 
          ...
          className="w-full bg-[#9A3412] hover:bg-[#C2410C] text-white py-6 rounded-2xl font-black text-xs tracking-[0.3em] uppercase flex items-center justify-center shadow-2xl shadow-orange-950/40 transition-all group relative overflow-hidden"
        >
        ...
        <p className="mt-8 text-stone-600 text-[10px] font-bold uppercase tracking-[0.2em] text-center">
